...
void loop()
{
  ...
  for (int i = 0; i < 8; i++) {
    pixels.setPixelColor(i * 8 + 7, pixels.Color(0, 0, 0)); // Moderately black.
  }
  for (int i = 0; i < cm3 / 30 && i < 8; i++) {
    pixels.setPixelColor(i * 8 + 7, pixels.Color(!flicker ? 150 : 0, 0, !flicker ? 0 : 150)); // Moderately bright green color.
    pixels.setPixelColor(63-(i * 8), pixels.Color(!flicker ? 150 : 0, 0, !flicker ? 0 : 150)); // Moderately bright green color.
  }
  for (int i = cm1 / 30; i < 7; i++) {
    pixels.setPixelColor(i, pixels.Color(0, 0, 0)); // Moderately black.
  }
  for (int i = cm2 / 30; i < 7; i++) {
  ...
  if (cm3 / 30 < 8){
    pixels.setPixelColor(((cm3 / 30) * 8) + 7, pixels.Color(!flicker ? 0 : 150, 0, !flicker ? 150 : 0));
    pixels.setPixelColor(63-(((cm3 / 30) * 8) ), pixels.Color(!flicker ? 0 : 150, 0, !flicker ? 150 : 0));
  }
